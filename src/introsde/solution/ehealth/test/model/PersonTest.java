...
public class PersonTest {
	...
	public void readPersonListTest() {
		...
		for (Person person : list) {
			System.out.println("--> Person = "+person.getFirstname() + "is born " + person.getBirthdate());
		}
	...
	public void addPersonTest() {
		...
		at.setBirthdate(cal.getTime().toString());
    ...
    public void personMeasurements() {
        ...
        List<Person> list = Person.getAll();
        List<MeasureHistory> measures = null;
        for(Person p : list) {
            measures=p.getMeasurements();
            System.out.println(p.getLastname()+" has some measurments:");
            assertNotNull(p);
            for (MeasureHistory m: measures) {
                System.out.println("  " + m.getMeasureType()+" : "+ m.getValue());
                assertNotNull(m.getMeasureType());
            }
        }
        assertNotNull(list);
